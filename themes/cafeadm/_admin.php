...
<body>
    ...
    <div class="dash">
        <aside class="dash_sidebar">
            ...
            echo $nav("fas fa-comments", "about/home", "Sobre");
            echo $nav("fas fa-id-card-alt", "contact/home", "Contato");
            echo $nav("fas fa-cog", "footer/home", "Configurações");
            echo $nav("fas fa-bullseye", "orcamento/home", "Orçamentos");
            echo $nav("fas fa-users", "candidatos/home", "Candidatos");
            echo $nav("fas fa-user", "users/home", "Usuários");
            echo $nav("fas fa-images", "slide/home", "Slides");
            echo $nav("fas fa-file-image", "banner/home", "Banner");
