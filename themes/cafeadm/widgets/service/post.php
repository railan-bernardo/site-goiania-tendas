    ...
    <?php if (!$post): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/produtos/post"); ?>" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                    <span class="legend">Icone ( PNG )</span>
                    <input type="file" name="icon" placeholder="Adicionar um icone"/>
                </label>
...
<!--                  <label class="label">
                ...
                <label class="label">
                    <span class="legend">Especificação Técnica:</span>
                    <textarea name="specification" placeholder="Especificação"></textarea>
                </label>

                <label class="label">
                    <span class="legend">Estrutura:</span>
                    <textarea name="structure" placeholder="Estrutura"></textarea>
                </label>
                ...
                <div class="al-right">
                    <button class="btn btn-blue icon-check-square-o">Prosseguir</button>
                </div>
            </form>
        </div>
    <?php else: ?>
...
<!--                  <label class="label">
                ...
                <label class="label">
                    <span class="legend">Especificação Técnica:</span>
                    <textarea name="specification" placeholder="Especificação"><?= $post->specification; ?></textarea>
                </label>

                <label class="label">
                    <span class="legend">Estrutura:</span>
                    <textarea name="structure" placeholder="Estrutura"><?= $post->structure; ?></textarea>
                </label>
                ...
                <div class="al-right">
                    ...
                    <a href="<?= url("/admin/produto/post_size_up/{$post->id}"); ?>" class="btn btn-yellow icon-pencil-square-o">Atualizar Tamanhos</a>
                </div>
            </form>
        </div>
    <?php endif; ?>
