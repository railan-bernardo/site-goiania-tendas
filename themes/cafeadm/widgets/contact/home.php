...
<section class="dash_content_app">
    ...
    <?php if(!$contacts): ?>
        <div class="message info icon-info">Nemhum contato.</div>
                <?php else: ?>
                <table>
                    <thead>
                    <tr>
                    ...
                    <?php foreach ($contacts as $contact):?>
                        ...
                        <tr>
                            ...
                            <td><?= $contact->email; ?></td>
                            <td><?= $contact->phone; ?></td>
                            <td><?php if(!$contact->msg == "vazio"): "" ?><?php else: ?><?= $contact->msg; ?> <?php endif;?></td>
                            <td>
                                <a href="#" class="remove_link icon-warning"
                                   data-post="<?= url("/admin/contact/post/{$contact->id}"); ?>"
                                   data-action="delete"
